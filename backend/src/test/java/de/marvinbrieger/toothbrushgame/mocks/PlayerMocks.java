...
public class PlayerMocks {
    ...
    public static final Player ELIAS = new Player(null, null, "Elias", null, null);

    public static final Player STORED_ELIAS = new Player(1L, null, "Elias", null, null);

    public static final Player MARVIN = new Player(null, null, "Marvin", null, null);

    public static final Player STORED_MARVIN = new Player(2L, null, "Marvin", null, null);
